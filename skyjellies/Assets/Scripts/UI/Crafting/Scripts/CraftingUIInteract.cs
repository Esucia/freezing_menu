...
public class CraftingUIInteract : MonoBehaviour
{
    ...
    public AK.Wwise.Event OpenCraftingSystem;
    public AK.Wwise.Event CloseCraftingSystem;
    ...
    private void Interact()
    {
        if (IsNearWorkBench)
        {
            if (_isUIOpen)
            {
                ...
                CloseCraftingSystem.Post(gameObject);
            ...
            else
            {
                ...
                OpenCraftingSystem.Post(gameObject);
            }
